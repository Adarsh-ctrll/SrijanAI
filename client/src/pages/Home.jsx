    ...
    <div className="relative min-h-screen bg-[#040404] text-white overflow-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto  px-6 py-4 flex justify-between items-center ">
          <div className="text-lg font-semibold">सृजन AI</div>
      ...
      <section className="pt-44 pb-32 px-6 text-center">
        ...
        >
          Think it. Describe it. सृजन AI builds it.
        </motion.p>

        <button
          className="mt-12 px-10 py-4 rounded-xl bg-white text-black font-semibold hover:scale-105
transition"
          onClick={() =>
...
{!userData &&       <section className="max-w-7xl mx-auto px-6 pb-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {highlights.map((h, i) => (
            ...
            >
              <h1 className="font-bold text-blue-500">{h}</h1>

              <p>
                Inspired by the meaning of{" "}
                <span className="font-semibold">"सृजन"</span>. Srijan
                AI turns your imagination into production-ready websites with
                AI-generated code, responsive layouts, and effortless
                deployment.
              </p>
            </motion.div>
          ))}
      ...
      <footer className="border-t border-white/10 py-10 text-center text-sm text-zinc-500">
        &copy; {new Date().getFullYear()} सृजन AI || Build with Love by Adarsh
      </footer>
